...
#define Mode_Win 20
#define SEGMENT_RECT_WIDTH 1
#define SEGMENT_RECT_HEIGHT 5
#define TRIANGLE_HEIGHT 1
...
{
	int triangleHeight = TRIANGLE_HEIGHT * size;
...
void iDrawDigit(int x, int y, int digit, int size)
{
	if (digit == 0 || digit == 2 || digit == 6 || digit == 8)
		VerticalSegment(x, y, SEGMENT_RECT_WIDTH * size, SEGMENT_RECT_HEIGHT * size, size);
	if (digit == 0 || digit == 4 || digit == 5 || digit == 6 || digit == 8 || digit == 9)
		VerticalSegment(x, y + SEGMENT_RECT_HEIGHT * size + 2 * TRIANGLE_HEIGHT * size, SEGMENT_RECT_WIDTH * size, SEGMENT_RECT_HEIGHT * size, size);
	if (digit == 0 || digit == 2 || digit == 3 || digit == 5 || digit == 6 || digit == 7 || digit == 8 || digit == 9)
		HorizontalSegment(x, y + 2 * SEGMENT_RECT_HEIGHT * size + 4 * TRIANGLE_HEIGHT * size, SEGMENT_RECT_HEIGHT * size, SEGMENT_RECT_WIDTH * size, size);
	if (digit == 2 || digit == 3 || digit == 4 || digit == 5 || digit == 6 || digit == 8 || digit == 9)
		HorizontalSegment(x, y + SEGMENT_RECT_HEIGHT * size + 2 * TRIANGLE_HEIGHT * size, SEGMENT_RECT_HEIGHT * size, SEGMENT_RECT_WIDTH * size, size);
	if (digit == 0 || digit == 2 || digit == 3 || digit == 5 || digit == 6 || digit == 8 || digit == 9)
		HorizontalSegment(x, y, SEGMENT_RECT_HEIGHT * size, SEGMENT_RECT_WIDTH * size, size);


	if (digit == 0 || digit == 1 || digit == 3 || digit == 4 || digit == 5 || digit == 6 || digit == 7 || digit == 8 || digit == 9)
		VerticalSegment(x + SEGMENT_RECT_HEIGHT * size + 2 * TRIANGLE_HEIGHT * size, y, SEGMENT_RECT_WIDTH * size, SEGMENT_RECT_HEIGHT * size, size);
	if (digit == 0 || digit == 1 || digit == 2 || digit == 3 || digit == 4 || digit == 7 || digit == 8 || digit == 9)
		VerticalSegment(x + SEGMENT_RECT_HEIGHT * size + 2 * TRIANGLE_HEIGHT * size, y + SEGMENT_RECT_HEIGHT * size + 2 * TRIANGLE_HEIGHT * size, SEGMENT_RECT_WIDTH * size, SEGMENT_RECT_HEIGHT * size, size);
}
